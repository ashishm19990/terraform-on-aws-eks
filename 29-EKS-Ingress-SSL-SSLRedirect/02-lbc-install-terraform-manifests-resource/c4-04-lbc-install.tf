...
# Reference Values Take From Below
...
resource "helm_release" "loadbalancer_controller" {
  ...
  set {
    ...
    value = "602401143452.dkr.ecr.us-east-1.amazonaws.com/amazon/aws-load-balancer-controller" #"public.ecr.aws/eks/aws-load-balancer-controller" # 602401143452.dkr.ecr.us-east-1.amazonaws.com/amazon/aws-load-balancer-controller
